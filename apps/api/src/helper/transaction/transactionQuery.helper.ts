...
export const getTransactionAdminByInvoice = async (user: IUser, invoice: string) => {
...
export const getTransactionsByParams = async (userId: string, status?: string[], from?: string, until?: string, page?: string) => {
    // get 6 per page
    const transactions = await prisma.transactions.findMany({
        where: {
            AND: {
...
export const getTransactionsAdminByParams = async (adminId: string, status?: string[], from?: string, until?: string, storesId?: string[], role?: E_Role, page?: string) => {
    // get max 10 trx data
...
export const getTrxByParamsTotalPage = async (user: IUser, status?: string[], from?: string, until?: string,) => {
...
export const getTrxAdminByParamsTotalPage = async (adminId: string, status?: string[], from?: string, until?: string, storesId?: string[], role?: E_Role) => {
