...
async function deleteProduct(
  ...
  try {
    ...
    if (response) {
      setDisabled(true);
      toast.success(response.message || 'Product successfully deleted!');
      router.push(`/dashboard/products/${id}/edit?status=deleted`);
    } else {
      setDisabled(false);
...
function EditProductFormDeleteAlert({
  disabled,
  setDisabled,
  id,
}: {
...
export default EditProductFormDeleteAlert;
